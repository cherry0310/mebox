        ...
        return(
            <ul className="course-list">
                {courseLists.map((item,index) => {
                    return (
                        <li key={index} className="course-item" onClick = {() => this.handleListItemClick(index)}>
                            <div className="course-info">
                                <div className="title">919经济学原理</div>
                                <div className="name" onClick = {this.handleCourseClick.bind(this,index)}><span>南京大学 020204金融学</span></div>
